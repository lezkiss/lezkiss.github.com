...
fixWidgetContainer();},"4":function(){resetContainerTop();resetPageTop();resetContainerHeight();aboutThenLauncher();removeHomeLink();fixWidgetContainer();}};$this.hideWidgets();layouts[$this.type]();};this.fixClasses=function(){$j(".page").attr("class",null).addClass("page").addClass($this.className());};this.fixLayout=function(isInit){this.fixClasses();this.fixHtml();if(!isInit)this.saveLayout();};this.fixLayout(true);return this;}
